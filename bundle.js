 ...
 */
var d3Module = function d3Module() {
	...
	var initGraph = function initGraph() {
		...
		var app = d3.select('#app').attr('class', 'example-d3'),
		    graph = void 0,
		    margin = {
			top: 40,
			right: 40,
		...
		graph.append('text').attr('y', 50).text('d3 module initialized.');
	};
...
},{"d3":300}],2:[function(require,module,exports){
'use strict';
...
var _exampleVanilla = require('./example-vanilla');

var _exampleVanilla2 = _interopRequireDefault(_exampleVanilla);

var _exampleD = require('./example-d3');

var _exampleD2 = _interopRequireDefault(_exampleD);
...
var init = function init(module) {
	...
	switch (module) {
		case "vanilla":
			return (0, _exampleVanilla2.default)().init();
		case "d3":
			return (0, _exampleD2.default)().init();
	}

	console.error('No module matching ' + module + ' found.');
};

var containingScriptTag = document.querySelector('script[data-module]') || {};
init(containingScriptTag.dataset && containingScriptTag.dataset.module);

},{"./example-d3":1,"./example-vanilla":2,"babel-polyfill":4}],4:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":5,"core-js/shim":299,"regenerator-runtime/runtime":302}],5:[function(require,module,exports){
